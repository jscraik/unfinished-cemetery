...
death: 2026-02
cause: policy-risk
tags: [api, policy, safety]
repo: https://github.com/jscraik/xKit
...
X changed its API policy. The new risk profile meant using the toolkit could expose people to account actions I couldn't control or defend against.
